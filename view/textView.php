<?php
require('../controller/textViewController.php');
?>
<!DOCTYPE html>
<html lang="fr">
<head>
    ...
    <title>Textes</title>
    <link href="../css/textView.css" rel="stylesheet" type="text/css" media="screen">
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.0/jquery.min.js" type="text/javascript"></script>
    <script src="../js/textView.js"></script>
</head>
<body>
...
<div id="mainWrapper">
    ...
    <header id="mainHeader">
        ...
        <nav id="mainNav">
            <ul id="mainMenu">
                ...
                <li class="positionningLeft"><a href="">Textes</a></li>
    ...
    <div id="mainContent">
        ...
        <!-- Beginning of the block "songTextNav" -->
        <nav id="songTextNav">
            <ul id="songTextMenu">
                <?php foreach ($textsData as $id => $textData) : ?>
                    <li><?php echo $textData['title']; ?></li>
                <?php endforeach; ?>
            </ul>
        </nav>
        <!-- End of the block "songTextNav" -->

        <!-- Beginning of the block "songTextInformationContainer" -->
        <section id="songTextInformationContainer">
            <p class="howToDoParagraph">
                Bienvenue sur la page consacrée à mes textes. Pour lire le texte d'une de mes compositions, veuillez sélectionner
                l'un d'eux dans le menu tournant présent juste au dessus.
            </p>
        </section>
        <!-- End of the block "songTextInformationContainer" -->
